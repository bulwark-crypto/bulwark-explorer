    ...
    return (
      <div className="animated fadeInUp">
        <Card className="card--status" >
          ...
          <div class="card__row mt-1 pt-1 border-top">
            <span class="card__label">{getCarverIcon()} Unique Data Points:</span>
            <span class="card__result">
              {numeral(this.props.countCarverAddresses).format('0,0')}</span>
          </div>
          <div class="card__row">
            <span class="card__label">{getCarverIcon()} Network Movements:</span>
