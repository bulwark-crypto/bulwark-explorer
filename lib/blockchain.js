...
export const avgBlockTime = 90; // 1.5 minutes (90 seconds)

export const blocksPerDay = (24 * 60 * 60) / avgBlockTime; // 960

export const blocksPerWeek = blocksPerDay * 7; // 6720

export const blocksPerMonth = (blocksPerDay * 365.25) / 12; // 29220

export const blocksPerYear = blocksPerDay * 365.25; // 350640

export const mncoins = 5000.0;

export const getSubsidy = (nHeight = 0) => {
  let nSubsidy = 0.0;
...
export const getMNSubsidy = (nHeight = 0, nMasternodeCount = 0, nMoneySupply = 0) => {
...
export const getROIDay = (subsidy, mncoins = 5000.0) => {
  console.log('getROIDay', subsidy, mncoins);
  return ((blocksPerDay * subsidy) - (mncoins / 365.25)) / mncoins;
};

export const getROIWeek = (subsidy, mncoins = 5000.0) => {
  return ((blocksPerWeek * subsidy) - mncoins) / mncoins;
};

export const getROIMonth = (subsidy, mncoins = 5000.0) => {
  return ((blocksPerMonth * subsidy) - mncoins) / mncoins;
};

export const getROIYear = (subsidy, mncoins = 5000.0) => {
  const principal = mncoins * subsidy;
  const gain = (blocksPerYear * subsidy) * mncoins;
  const days = 365;
  console.log(principal, gain, days);
  return ((principal + gain) / gain);
};
