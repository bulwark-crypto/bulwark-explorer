...
export const blocksPerDay = (24 * 60 * 60) / avgBlockTime;

export const blocksPerWeek = blocksPerDay * 7;

export const blocksPerMonth = (blocksPerDay * 365.25) / 12;

export const blocksPerYear = blocksPerDay * 365.25;
...
export const getROIDay = (subsidy, mncoins = 5000.0) => {
  return ((blocksPerDay * subsidy) - mncoins) / mncoins;
};
