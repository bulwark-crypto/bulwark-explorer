...
export const getMNBlocksPerDay = (mns) => {
  return blocksPerDay / mns;
};

export const getMNBlocksPerWeek = (mns) => {
  return getMNBlocksPerDay(mns) * (365.25 / 52);
};

export const getMNBlocksPerMonth = (mns) => {
  return getMNBlocksPerDay(mns) * (365.25 / 12);
};

export const getMNBlocksPerYear = (mns) => {
...
export const getROI = (subsidy, mns) => {
